...
export const ElevatingEssentials = () => {
  return (
      ...
      <div className="container px-4">
        ...
        >
          ...
          <p className="text-gray-600 text-xl max-w-3xl mx-auto">
            Experience the perfect harmony of comfort and sustainability with Elloria's innovative feminine care products. 
            Our advanced technology delivers unmatched protection while honoring our commitment to the environment.
          </p>
        </motion.div>
