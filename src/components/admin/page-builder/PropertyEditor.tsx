...
import { ContentBlock, BlockContent, FeatureItem, SustainabilityContent, ComparisonMetric } from "@/types/content-blocks";
                ...
                <div key={index} className="space-y-4 p-4 border rounded-lg">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        const newMetrics = [...metrics];
                        newMetrics[index] = { ...newMetrics[index], elloria: Number(e.target.value) };
                        handleChange('metrics', newMetrics);
                      }}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        const newMetrics = [...metrics];
                        newMetrics[index] = { ...newMetrics[index], competitors: Number(e.target.value) };
                        handleChange('metrics', newMetrics);
                      }}
                    />
                  </div>
