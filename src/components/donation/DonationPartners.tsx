  ...
  return (
    <section className="py-20 bg-accent-purple/5">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">{content.title || "Our Partners in Change"}</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {content.subtitle || "We work with trusted organizations to ensure your donations reach those who need them most."}
          </p>
        </motion.div>
