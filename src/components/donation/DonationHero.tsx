      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900">
            {String(content.title || "Join Us in Supporting Women and Children in Need")}
          </h1>
          <p className="text-xl md:text-2xl text-gray-800 mb-8">
            {String(content.description || "Your contribution helps provide essential hygiene products and support to those who need it most.")}
          </p>
          <button
            onClick={() => {
          ...
          >
            {String(content.buttonText || "Donate Now")}
          </button>
        </motion.div>
      </div>
    </section>
