...
export default function Thanks() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-accent-purple/5 to-white pt-32 pb-12 px-4 md:px-6">
      <div className="max-w-4xl mx-auto space-y-8 md:space-y-16">
        ...
        <motion.section 
          ...
          className="bg-gradient-to-br from-accent-purple/30 via-accent-peach/20 to-accent-green/20 rounded-2xl md:rounded-3xl p-6 md:p-12 space-y-8"
        >
          <div className="text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Share and Get More Rewards!</h2>
        ...
        <motion.section
          ...
          className="relative overflow-hidden bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl md:rounded-3xl p-8 md:p-12 text-center"
        >
          <motion.div
            animate={{ 
              scale: [1, 1.2, 1],
          ...
          <Button asChild size="lg" className="w-full md:w-auto bg-primary hover:bg-primary/90 text-white px-6 md:px-8">
            <a href="/shop" className="flex items-center justify-center gap-2">
