...
import { LogOut, LayoutDashboard, Package, Users, FileText, ShoppingCart, Settings, FolderIcon, Tag, CreditCard, Truck, Boxes } from "lucide-react";
        ...
        <Tabs defaultValue="dashboard" className="space-y-6">
          <div className="w-full overflow-x-auto pb-2">
            <TabsList className="w-full grid grid-cols-11 gap-1">
              ...
              <TabsTrigger value="inventory" className="flex items-center gap-2 py-3 px-4">
